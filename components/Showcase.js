  ...
  return (
    <div className='bg-gradient-to-b from-slate-950 to-slate-900'>
      ...
      {isLightboxOpen && (
        ...
        >
          <div
            className="relative w-full max-w-7xl max-h-full p-12 rounded-lg"
            onClick={(e) => {
          ...
          >
            <button onClick={closeLightbox} className="absolute top-2 right-2 text-white text-2xl z-50">
              &times;
            </button>
            ...
            <button onClick={handlePreviousImage} className="absolute left-2 top-1/2 transform -translate-y-1/2 text-white bg-indigo-600 p-1 rounded-md z-50">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <button onClick={handleNextImage} className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white bg-indigo-600 p-1 rounded-md z-50">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </button>
