  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-950 to-indigo-950">
      <div className="container mx-auto px-1 lg:px-32">
        <h2 className="text-4xl font-display font-bold text-center mb-12">Who we are</h2>
        
        <div className="flex flex-col md:flex-row justify-center ">
          {/* Ryan Cossette Card */}
          <div className=" overflow-hidden flex-1 max-w-fit p-5">
            <div className="relative w-full mb-10" style={{ height: '400px' }}>
              <Image
